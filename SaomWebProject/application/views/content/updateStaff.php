...
<body>
  ...
  <header class="main-header clearfix" role="header">
    ...
    <section class="section main-banner" id="top" data-section="section1">
        <h1 id="updateStaffMemberTitle">Update Staff Member</h1>
          
      <form class="updateForm">
            <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputEmail4">Firstname/LastName</label>
      <input type="email" class="form-control" id="inputEmail4" placeholder="Firstname/LastName">
    </div>
    <div class="form-group col-md-4">
      <label for="inputPassword4">Teaching Courses</label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="Teaching Courses">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
