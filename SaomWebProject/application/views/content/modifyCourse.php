...
<div class="container-fluid">
                ...
                <div class="container">
                  <form action="#" class="mod_form">
                    ...
                    <label for="fname">Name of the course</label>
                    <input type="text" id="fname" name="firstname" value="Networking">

                    <label for="lname">Department</label>
                    <input type="text" id="lname" name="lastname" value="Information Technology">

                    <label for="lname">Supervisor</label>
                    <input type="text" id="lname" name="department" value="Joe Bloggs">

                    <label for="subject">Date Established</label>
                    <input type="text" id="lname" name="dateHired" value="April 18, 2017" readonly>

                    <input type="submit" value="Submit" class="formButton">
                    
                </form>
                <a href="manageCourse.html"><button class="formButton">Back</button></a>
</div>   
