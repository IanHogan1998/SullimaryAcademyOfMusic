...
<div class="container-fluid">
                ...
                <div class="container">
                  <form action="#" class="mod_form">
                    ...
                    <input type="text" id="lname" name="dateHired" value="4th" readonly>

                    <label for="subject">Course</label>
                    <input type="text" id="lname" name="dateHired" value="Internet System Development" readonly>

                    <input type="submit" value="Submit" class="formButton">
                    
                </form>
                <a href="manageStudent.html"><button class="formButton">Back</button></a>
</div>   
