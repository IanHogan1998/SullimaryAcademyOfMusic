...
<body>
  ...
  <header class="main-header clearfix" role="header">
    ...
    <div class="form-group col-md-4">
      <label for="inputPassword4">Teaching Course</label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="Teaching Course">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" id="inputAddress" placeholder="Author">
  </div>
 </div>
<div class="form-row">
  <div class="form-group col-md-4">
