                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Date Hired</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="txt-oflo">Administration</td>
                                            <td><span class="font-medium">April 18, 2017</span></td>
                                            <td><a href="modifyStaff.html"><button class="font-medium">Modify</button></a></td>
                                            <td><a href="updateStaff.html"><button class="font-medium">Update</button></a></td>
                                        </tr>
                                        <tr>
                                            <td class="txt-oflo">2</td>
                                            <td class="txt-oflo">Anne</td>
                                            <td><span class="label label-info label-rounded">Bell</span></td>
                                            <td class="txt-oflo">Teaching Staff</td>
                                            <td><span class="font-medium">April 19, 2017</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="txt-oflo">Teaching Staff</td>
                                            <td><span class="font-medium">April 20, 2017</span></td>
                                            <td><button class="font-medium">Modify</button></td>
                                            <td><a href="updateStaff.html"><button class="font-medium">Update</button></a></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="txt-oflo">Teaching Staff</td>
                                            <td><span class="font-medium">April 21, 2017</span></td>
                                            <td><button class="font-medium">Modify</button></td>
                                            <td><a href="updateStaff.html"><button class="font-medium">Update</button></a></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="txt-oflo">Maintenance</td>
                                            <td><span class="font-medium">April 23, 2017</span></td>
                                            <td><button class="font-medium">Modify</button></td>
                                            <td><a href="updateStaff.html"><button class="font-medium">Update</button></a></td>
